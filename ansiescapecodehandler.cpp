...
AnsiEscapeCodeHandler::AnsiEscapeCodeHandler() : m_scrollBar(nullptr)
{

}

AnsiEscapeCodeHandler::AnsiEscapeCodeHandler(QTextCursor textCursor, QScrollBar *scrollBar) : m_textCursor(textCursor), m_scrollBar(scrollBar)
{

}

AnsiEscapeCodeHandler &AnsiEscapeCodeHandler::operator=(AnsiEscapeCodeHandler &&move)
{
